...
use Modules\Hr\Entities\InventoryType;
...
class InventoryTypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $result = InventoryType::where('company_id' , $request->get('company_id'))->paginate($request->get('paginateCount'));
    ...
    public function update(Request $request, $id)
    {
        ...
        try
        {
            DB::beginTransaction();
            $saved = true;
            $inventoryType = InventoryType::where('id', $id)
    ...
    {
        return InventoryType::where('id', $id)->where('company_id', $request->get('company_id'))->delete()
            ? $this->successResponse(trans('messages.saved'))
            : $this->errorResponse(trans('messages.not_saved'));
    }
