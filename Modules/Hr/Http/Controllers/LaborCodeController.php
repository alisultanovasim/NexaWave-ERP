...
use Modules\Hr\Entities\LaborCode;
...
class LaborCodeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $result = LaborCode::where('company_id' , $request->get('company_id'))->paginate($request->get('paginateCount'));
    ...
    public function update(Request $request, $id)
    {
        ...
        try
        {
            DB::beginTransaction();
            $saved = true;
            $laborCode = LaborCode::where('id', $id)->where('company_id' , $request->get('company_id'))->first(['id']);
            if (!$laborCode)
    ...
    {
        return LaborCode::where('id', $id)->where('company_id', $request->get('company_id'))->delete()
            ? $this->successResponse(trans('messages.saved'))
            : $this->errorResponse(trans('messages.not_saved'));
    }
