...
class WorkChange extends Order implements OrderType
{
    ...
    public function getEmployeeValidateRules(): array
    {
        return [
            ...
            'employees.*.details.new_department_name' => 'nullable|min:3|max:255',
            'employees.*.details.new_section_id' => 'nullable|integer',
            'employees.*.details.new_section_name' => 'nullable|min:3|max:255',
            'employees.*.details.new_sector_id' => 'nullable|integer',
            'employees.*.details.new_sector_name' => 'nullable|min:3|max:255',
            ...
            'employees.*.details.new_qualification_degree' => 'nullable|min:3|max:255',
